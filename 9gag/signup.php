	...
	<body>
		...
		<div class="sayfa">
			...
			<div class="sagalt">
				...
				<form action="baglan_signup.php" method="post">
					<br>
						Nickname
						<input type="text" name="uye_nickname" value="uye_nickname">
					<br>
					<br>
						Email Address
						<input type="email" name="uye_email" value="uye_email">
					<br>
					<br>
						Password
						<input type="password" name="uye_sifre" value="uye_sifre">
					<br>
					<br>
